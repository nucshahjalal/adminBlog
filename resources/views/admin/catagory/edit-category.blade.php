...
<section class="content-header">
  ...
  <input type="hidden" name="category_id" value="<?php echo $category->id; ?>">
	<input type="text" name="catagory" class="form-control form-control-sm" id="exampleInputEmail1" value="<?php echo $category->name;?>" placeholder="Catagory name" oninvalid="this.setCustomValidity('Please Enter Category Name')" oninput="setCustomValidity('')">
	</div>
